...
def run_large_batch_matmul():
    ...
    configs = [
        ...
        (512, 64, 256, 1024, "B512 x 64, 256->1024"),
        
        # Large batch with larger dimensions
        (64, 128, 512, 4096, "B64 x 128, 512->4096"),
        (128, 128, 512, 4096, "B128 x 128, 512->4096"),
        (64, 256, 1024, 4096, "B64 x 256, 1024->4096"),
        (128, 128, 1024, 4096, "B128 x 128, 1024->4096"),
    ]
...
def run_long_sequence_summary():
    ...
    configs = [
        # Long sequence, single batch
        (8192, 1024, 1024, "8K x 1024 -> 1024"),
        (16384, 1024, 1024, "16K x 1024 -> 1024"),
        
        # V reconstruction (256 -> 1024) with large batch
        (64 * 128, 256, 1024, "B64x128 x 256 -> 1024"),
        (64 * 256, 256, 1024, "B64x256 x 256 -> 1024"),
        (128 * 128, 256, 1024, "B128x128 x 256 -> 1024"),
        (128 * 256, 256, 1024, "B128x256 x 256 -> 1024"),
        (256 * 128, 256, 1024, "B256x128 x 256 -> 1024"),
        
        # Large total tokens with varying batch/seq
        (64 * 512, 256, 1024, "B64x512 x 256 -> 1024"),
        (128 * 256, 256, 1024, "B128x256 x 256 -> 1024"),
        (256 * 128, 256, 1024, "B256x128 x 256 -> 1024"),
    ]
